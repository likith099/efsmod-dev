...
namespace aspnet_get_started.App_Code
{
    public class AzureAuthModule : IHttpModule
    {
        ...
        private void Context_PostAuthenticateRequest(object sender, EventArgs e)
        {
            ...
            // Check if we have Azure App Service authentication headers
            var principalHeader = context.Request.Headers["X-MS-CLIENT-PRINCIPAL"];
            ...
            if (!string.IsNullOrEmpty(principalHeader))
            {
                try
                {
                    ...
                    if (principal != null && !string.IsNullOrEmpty(principal.UserId))
                    {
                        ...
                        // Add additional claims from user details
                        ...
                        // Add claims from user claims if available
                ...
                catch (Exception ex)
                {
                    ...
                    System.Diagnostics.Debug.WriteLine($"Error parsing Azure authentication: {ex.Message}");
                }
            }
        }
